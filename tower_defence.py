...
class Enemy:
    def __init__(self):
        ...
        self.type= random.randint(0,2)# 0: normal, 1: fast, 2: tank
        self.x, self.z = self.path[0]  # Start at first waypoint
        self.base_speed = [0.3, 0.5, 0.2][self.type]
        self.speed =self.base_speed 
        self.scale = [0.5, 0.4, 0.8][self.type]
        self.color = [(10/255, 101/255, 34/255), (0, 1, 0), (0, 0, 1)][self.type]
        self.rotation = 0  # Y-axis rotation in degrees
        self.health = [100, 80, 150][self.type]
